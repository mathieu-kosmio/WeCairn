 ...
 * quand un commentaire arrive, l'auteur de la pierre et ceux qui en discutent le sont aussi.
 *
...
/** Des commentaires sont arrivés : ctx = { appName, appURL, orgName, isAuthor, retex: { id, title }, comments: [{ authorName, body }] } */
...
function notifyComments(app, m) {
  ...
  for (const retexId of Object.keys(byRetex)) {
    ...
    // Destinataires : l'auteur de la pierre et toute personne ayant déjà commenté, sauf pour leurs propres mots
